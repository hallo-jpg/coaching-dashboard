...
1. `get_readiness_score` → Score 0–100, Ampel-Empfehlung, Komponenten (HRV + Ruhepuls als 7d-Trend vs. 30d-Normalbereich, Schlaf, Gefühl; TSB zählt nicht mit – Details `COACH_MEMORY.md`)
